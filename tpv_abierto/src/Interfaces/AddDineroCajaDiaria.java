...
public class AddDineroCajaDiaria extends JDialog implements ActionListener {
	...
	public AddDineroCajaDiaria() {
		...
		JLabel lblNewLabel_1 = new JLabel("QUE VAS A INTRODUCIR EN LA CAJA");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand() == "ACEPTAR") {
			...
			if (!dinero.equals(null)) {
				double dineroAIntroducir = Double.parseDouble(dinero);
				double dineroEnCaja = caja.getDineroCaja();
				dineroAIntroducir = dineroAIntroducir + dineroEnCaja;
				caja.setDineroCaja(dineroAIntroducir);
				dispose();
			}
		}
