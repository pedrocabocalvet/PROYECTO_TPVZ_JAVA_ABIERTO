...
public class DJiTextTicket {
	...
	public DJiTextTicket(Mesa mesa, boolean muestro, boolean imprimo, String ticket, String textoFinal){
		mostrar = muestro;
		...
		rutaGuardarTicketPrevio="./ReportesTicketPrevio/";
		...
		// Creacion del parrafo
		   ...
		   paragraph.add(new Phrase(ticket, fontTitulos));  
